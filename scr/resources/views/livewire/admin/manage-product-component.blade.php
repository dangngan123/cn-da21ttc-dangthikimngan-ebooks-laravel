                                ...
                                <form class="contact-form-style mt-30 mb-50" action="#" method="post">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-style mb-10">
                                            ...
                                            <input name="order-id" placeholder="Nhập mô tả ngắn..." type="text" class="square" wire:model="short_description">
                                            @error('short_description') <span class="error text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="input-style mb-10">
                                            <label>Mô tả dài</label>
                                            <input name="order-id" placeholder="Nhập mô tả dài..." type="text" class="square" wire:model="long_description">
                                            @error('long_description') <span class="error text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="input-style mb-10">
                                            <label>Nhà xuất bản</label>
                                            <input name="billing-email" placeholder="Nhà xuất bản..." type="text" class="square" wire:model="publisher">
                                            @error('publisher') <span class="error text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="input-style mb-10">
                                            <label>Tác giả</label>
                                            <input name="order-id" placeholder="Tác giả..." type="text" class="square" wire:model="author">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-style mb-10">
                                            <label>Giá gốc</label>
                                            <input name="order-id" placeholder="Giá gốc..." type="text" class="square" wire:model="reguler_price" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            @error('reguler_price') <span class="error text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="input-style mb-10">
                                            <label>Giá giảm</label>
                                            <input name="order-id" placeholder="Giá giảm..." type="text" class="square" wire:model="sale_price" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        ...
                                        <div class="input-style mb-10">
                                            <div class="checkbox-wrapper">
                                                ...
                                                <input type="checkbox" id="is_hot" wire:model="is_hot" wire:change="updateIsHot($event.target.checked)">
                                            </div>
                                        ...
                                        <style>
                                            ...
                                            .dropdown-wrapper select {
                                                flex: 1;
                                                /* Đảm bảo select chiếm hết chiều rộng có sẵn */
                                                appearance: none;
                                            ...
                                            .dropdown-icon {
                                                position: absolute;
                                                right: 10px;
                                                /* Căn icon sát bên phải của dropdown */
                                                pointer-events: none;
                                                /* Đảm bảo icon không can thiệp vào tương tác */
                                                font-size: 16px;
                                                color: #aaa;
                                                /* Màu sắc của icon */
                                            }
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="{{$this->isColor($product->id)}}">
                            ...
                            <td>{{ $product->name }}</td>
                            <td style="color:  #F15412;">{{ $product->reguler_price }}đ</td>
                            <td>{{ $product->category->name ?? '' }}</td>
                            <td class="text-center">{{ $product->quantity }}</td>
                            <td><a href="{{ $product->getImage()}}" data-lightbox="example-1"><img src=" {{ $product->getImage()}}" alt="Slider Image" style="width:80px"></td>
