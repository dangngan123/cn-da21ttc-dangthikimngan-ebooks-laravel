                            ...
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-price">
                                        <span>{{$item->model->sale_price}}đ</span>
                                        <span class="old-price">{{$item->model->reguler_price}}đ</span>
                                    </div>
                                    <div class="product-action-1 show">
                                        ...
                                        <a aria-label="Move To Cart" class="action-btn hover-up" href="shop-cart.php" wire:click.prevent="moveToCart('{{$item->rowId}}')"><i class="fi-rs-shopping-bag-add"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
